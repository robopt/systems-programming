...
** Name:	c_putbuf
**
** Description:	Prints characters from a character buffer
** Arguments:	pointer to a buffer, count of characters to print
*/
...
**	routines have been called are lost.  This can cause errors in the
**	input translation because the states of the Shift and Ctrl keys may
**	not be tracked accurately.  If interrupts are disabled, the user is
**	advised to refrain from typing anything except when the program is
**	waiting for input.
*/
