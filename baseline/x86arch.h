/*
** SCCS ID:	@(#)x86arch.h	1.6	10/13/12
**
** File:	x86arch.h
**
...
** RFLAGS
*/
#define	RFLAGS_RSVD	0xffffffffffc00000	/* reserved */
#define	RFLAGS_MB0	0x0000000000008020	/* must be zero */
#define	RFLAGS_MB1	0x0000000000000002	/* must be 1 */

#define	RFLAGS_ID	0x0000000000200000
#define	RFLAGS_VIP	0x0000000000100000
#define	RFLAGS_VIF	0x0000000000080000
#define	RFLAGS_AC	0x0000000000040000
#define	RFLAGS_VM	0x0000000000020000
#define	RFLAGS_RF	0x0000000000010000
#define	RFLAGS_NT	0x0000000000004000
#define	RFLAGS_IOPL	0x0000000000003000
#define	RFLAGS_OF	0x0000000000000800
#define	RFLAGS_DF	0x0000000000000400
#define	RFLAGS_IF	0x0000000000000200
#define	RFLAGS_TF	0x0000000000000100
#define	RFLAGS_SF	0x0000000000000080
#define	RFLAGS_ZF	0x0000000000000040
#define	RFLAGS_AF	0x0000000000000010
#define	RFLAGS_PF	0x0000000000000004
#define	RFLAGS_CF	0x0000000000000001
